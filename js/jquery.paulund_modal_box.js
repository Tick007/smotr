	...
	$.fn.paulund_modal_box = function(prop){
		 ...
		 */
		 ...
		 function add_popup_box(){
			 var pop_up = $('<div class="paulund_modal_box"><a href="#b" class="paulund_modal_close"></a><div class="paulund_inner_modal_box"><h2>' + options.title + '</h2><p>' + options.description + '</p></div></div>');
