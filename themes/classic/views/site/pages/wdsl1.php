...
<definitions xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/"
             ...
             xmlns:tns="http://<?php echo $_SERVER['HTTP_HOST']?>/"
    ...
    <types>
        <xs:schema elementFormDefault="qualified"
                   ...
                   xmlns:xs="http://www.w3.org/2001/XMLSchema"
                   targetNamespace="http://<?php echo $_SERVER['HTTP_HOST']?>/">
    ...
    <service name="SmsService">
        <port name="SmsServicePort" binding="tns:SmsServiceBinding">
            <soap:address location="http://<?echo $_SERVER['HTTP_HOST']?>/site/page?view=smsservice" />
        </port>
    </service>
</definitions>